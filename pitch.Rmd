...
```{r csv}
dataset <- lastEdition
for (edition in pastEditions)
    dataset <- rbind(dataset, edition)
...
```
How many goals do you think they have scored?
...
[The web app with dynamic settings](https://guscastles.shinyapps.io/project/)